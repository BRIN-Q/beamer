...
% --- 1. NEW FOOTER (Dark Bar, Bottom Right) ---
\setbeamercolor{footline}{bg=cw, fg=white}

\setbeamertemplate{footline}{%
  \begin{beamercolorbox}[wd=\paperwidth, ht=2.5ex, dp=1.125ex, leftskip=1cm, rightskip=0.5cm]{footline}
    \hfill 
    \tiny  % Smaller font
...
% --- MACRO COVER BARU (Title Page with Footer Bar, No Number) ---
\newcommand{\printcover}{
    ...
    % 2. Custom Footer for Cover: Draw the bar, but NO text
    \setbeamertemplate{footline}{%
      \begin{beamercolorbox}[wd=\paperwidth, ht=2.5ex, dp=1.125ex, leftskip=1cm, rightskip=1cm]{footline}
        % Empty content preserves the bar color/size
      \end{beamercolorbox}%
    }
